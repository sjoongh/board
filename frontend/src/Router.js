...
function Router() {
    ...
    const [curPage, setCurPage] = Giact.useRouter(map[initPage.path]({ params: initPage.params, query: initPage.query }));
    const onChangeLocation = () => {
        Giact.clear();
        const nextPage = getPath();
        setCurPage(map[nextPage.path]({ params: nextPage.params, query: nextPage.query }));
    };
